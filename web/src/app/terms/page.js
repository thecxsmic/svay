          ...
          <div className="prose prose-invert prose-sm max-w-none text-zinc-400 space-y-6 leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Pro Plan Pricing:</strong> We offer full access to our creator intelligence tools under a monthly subscription priced at $14.99/month, or a yearly subscription priced at $9.99/month (billed annually as $119.99/year). Listed prices do not include applicable taxes, which may be calculated and added at checkout based on your location.</li>
