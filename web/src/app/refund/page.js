        ...
        <main className="md:col-span-9 space-y-6 text-left min-w-0 max-w-3xl">
          ...
          <div className="prose prose-invert prose-sm max-w-none text-zinc-400 space-y-6 leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p>
                However, if you notice double billing or transaction processing errors by Dodo Payments, please email our support team at <a href="mailto:help@svay.space" className="text-brand-volt font-mono">help@svay.space</a> within 7 days of the charge. We will audit the transaction logs and issue credit adjustments where appropriate.
              </p>
            </section>
          </div>
        </main>
