  ...
  return (
    <div
      className={cn(
        ...
        "hover:border-white/[0.12] hover:shadow-[0_0_60px_-28px_rgba(59,130,246,0.18)]",
        className
      )}
      style={{
        backgroundImage:
...
function AnalyticsDemo() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-white/[0.06] bg-gradient-to-b from-white/[0.03] to-black/40 p-3 sm:p-4">
      ...
      <div className="relative mt-2 flex justify-between font-mono text-[9px] text-white/20">
        <span>Mar</span>
    ...
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-3 lg:grid-cols-3">
      {items.map((item, i) => (
        ...
        >
          ...
          <div className="relative mt-3 h-8 sm:h-9">
